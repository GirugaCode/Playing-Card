...
class PlayingCardView: UIView {
    ...
    private lazy var uppperLeftCornerLabel = createCornerLabel()
    ...
    override func layoutSubviews() {
        ...
        configureCornerLabel(uppperLeftCornerLabel)
        uppperLeftCornerLabel.frame.origin = bounds.origin.offsetBy(dx: cornerOffset, dy: cornerOffset)
    }
